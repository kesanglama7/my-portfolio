...
//       if (!section || !stage || !entryPanel || !titleGroup || !topWord || !bottomWord || !fromLabel || !revealLayer) {
//         return;
//       }
...
//       // Initial state for Channel Bubble elements
//       gsap.set(".channel-bubble", { autoAlpha: 0, scale: 0 });
...
//         .to({}, { duration: 0.5 }) // Hold composition space
...
//       // --- RANDOM CHANNEL BUBBLES POPPING SYSTEM ---
//       // Keep "Fueled by Community" visible through the end of this section.
//       timeline.to(".channel-bubble", {
//         autoAlpha: 1,
//         scale: 1,
//         duration: 0.8,
//         ease: "back.out(2)",
//         stagger: {
//           amount: 0.6,
//           from: "random" // Pops up bubbles in an organically randomized sequence
//         }
//       }, 18.8);
...
//       ref={sectionRef}
//       id="journey"
//       className="relative z-20 h-[1500svh] bg-[#050505]" // Retained extended track space for relaxed scrolling experience
//     >
//       <div
//         ref={stageRef}
...
//             className="channel-bubble group pointer-events-auto relative flex h-full w-full cursor-pointer select-none items-center justify-center rounded-full border border-white/10 bg-[#102d29] shadow-lg transition-transform duration-300 will-change-transform hover:scale-105"
//           >
...
//             <style jsx global>{`
//               .channel-position {
//                 --bubble-size: clamp(74px, 19vw, 86px);
...
//                 .channel-position {
//                   --bubble-size: clamp(94px, 13vw, 115px);
//                   transform: translate3d(
...
//       <div className="w-full h-screen bg-[#f3efe7]" />
//     </section>
//   );
// }
...
function JourneyPathStory() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative z-30 w-full bg-[#030303] text-white"
      style={{
      ...
      <div className="sticky top-0 h-[100svh] w-full overflow-hidden bg-[#030303]">
        ...
        >
          ...
          <div className="max-w-2xl px-2">
            ...
            <div className="journey-end-typography">
              <a
                href="#contact"
                className="inline-flex h-11 items-center justify-center rounded-full bg-neutral-950 px-8 text-xs font-bold uppercase tracking-widest text-white shadow-xl transition-all duration-200 hover:bg-neutral-800 active:scale-95"
              >
                Get In Touch
              </a>
            </div>
...
function JourneyBridge() {
  return (
    <section className="relative z-[25] flex min-h-[100svh] items-center justify-center overflow-hidden bg-[#f3efe7] px-6 py-24 text-center text-[#102d29]">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(#102d29_1px,transparent_1px)] opacity-10 [background-size:24px_24px]" />
      <div className="relative mx-auto max-w-3xl">
        <p className="mb-4 font-mono text-xs font-bold uppercase tracking-[0.35em] text-[#ff4c3f]">
          From Learning
        </p>
        <h2 className="text-4xl font-black uppercase leading-[0.9] tracking-tight sm:text-6xl md:text-7xl">
          Into Real Work
        </h2>
        <p className="mx-auto mt-6 max-w-xl text-sm font-medium leading-relaxed text-[#102d29]/70 sm:text-base md:text-lg">
          The curiosity, community, and self-learning now move into the next
          chapter — internships, professional growth, graduation, and building
          real products.
        </p>
      </div>
    </section>
